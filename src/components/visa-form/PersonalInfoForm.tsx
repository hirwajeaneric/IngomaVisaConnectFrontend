...
import { personalInfoSchema, PersonalInfoValues } from "@/lib/schemas/visaFormSchema";
...
const PersonalInfoForm = ({ defaultValues, onSubmit, onBack, isLoading = false }: PersonalInfoFormProps) => {
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Employer Details (Optional)</FormLabel>
                  <FormControl>
                    <Input {...field} disabled={isLoading} />
                  </FormControl>
                  <FormDescription>
